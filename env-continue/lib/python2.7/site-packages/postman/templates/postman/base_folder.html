...
<div id="postman">
  ...
  <div layout='row' id="pm_buttons">
    ...
    <div class="button button-small button-gray"
        type="submit"
        onclick="this.form.action='{% url 'postman_delete' %}'">
      {% trans "Delete" %}
    </div>
    {% endblock pm_delete_button %}
    &nbsp;&nbsp;&nbsp;
    {% block pm_archive_button %}
    <div class="button button-small button-gray"
        type="submit"
        onclick="this.form.action='{% url 'postman_archive' %}'">
      {% trans "Archive" %}
    </div>
    {% endblock pm_archive_button %}

    {% block pm_undelete_button %}
    <div class="button button-small button-gray"
        type="submit"
        onclick="this.form.action='{% url 'postman_undelete' %}'">
      {% trans "Undelete" %}
    </div>
    {% endblock pm_undelete_button %}
  </div>
