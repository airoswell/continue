...
<span id="pm_buttons">
<button type="submit" onclick="this.form.action='{% url 'postman_delete' %}'">{% trans "Delete" %}</button>
<button type="submit" onclick="this.form.action='{% url 'postman_archive' %}'">{% trans "Archive" %}</button>
<button type="submit" onclick="this.form.action='{% url 'postman_undelete' %}'">{% trans "Undelete" %}</button>
</span>
<table id="pm_messages">
 ...
 <th><a href="{% postman_order_by sender %}">{% trans "Sender" %}</a></th>
   ...
   <th><a href="{% postman_order_by date %}">{% trans "Date" %}</a></th>
  </tr>
 </thead>
