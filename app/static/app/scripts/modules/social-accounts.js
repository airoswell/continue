...
(function() {
  angular.module("worldsheet.social_accounts", ["worldsheet.social_accounts.facebook", "worldsheet.social_accounts.instagram"]);
  ...
  angular.module("worldsheet.social_accounts.instagram", ["ngResource"]);

  angular.module("worldsheet.social_accounts.instagram").factory("Instagram", [
    "$resource", "Auth", function($resource, Auth) {
      var resource;
