...
(function() {
  angular.module("worldsheet").controller("EditCtrl", [
    "$scope", "$location", "get_item", function($scope, $location, get_item) {
      $scope.item = get_item;
    ...
    "Alert", "Item", "Album", "Auth", "$upload", "settings", "$modal", function(Alert, Item, Album, Auth, $upload, settings, $modal) {
      return {
        restrict: "E",
