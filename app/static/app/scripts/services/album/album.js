...
(function() {
  angular.module("worldsheet").factory("Album", [
    "$q", "FB", "Instagram", "Auth", "BS", function($q, FB, Instagram, Auth, BS) {
      var get_FB_albums, get_Instagram_albums, get_photos;
      ...
      get_Instagram_albums = function(self) {
